...
function appcraft_register_api_hooks()
{
    ...
    // 获取文章详情
    register_rest_route('wp-app-craft/v1', '/posts/(?P<id>\d+)', array(
        'methods' => 'POST',
    ...
    // 获取某个文章评论列表
    register_rest_route('wp-app-craft/v1', '/comments/(?P<id>\d+)', array(
        'methods' => 'GET',
        'callback' => 'appcraft_get_comment',
        'permission_callback' => '__return_true',
    ));
    // 获取某个用户的评论列表
    register_rest_route('wp-app-craft/v1', '/comments_by_user', array(
        'methods' => 'GET',
        'callback' => 'appcraft_get_comments_by_user',
        'permission_callback' => '__return_true',
    ));
    // 创建评论
    register_rest_route('wp-app-craft/v1', '/comment', array(
        'methods' => 'POST',
    ...
    // 获取分类列表
    register_rest_route('wp-app-craft/v1', '/categories', array(
        'methods' => 'GET',
    ...
    // 获取标签列表
    register_rest_route('wp-app-craft/v1', '/tags', array(
        'methods' => 'GET',
    ...
    // 获取标签详情
    register_rest_route('wp-app-craft/v1', '/tags/(?P<id>\d+)', array(
        'methods' => 'GET',
        'callback' => 'appcraft_get_tag',
        'permission_callback' => '__return_true',
    ));
    // 获取页面详情
    register_rest_route('wp-app-craft/v1', '/pages/(?P<id>\d+)', array(
        'methods' => 'GET',
    ...
    register_rest_route('wp-app-craft/v1', '/login', array(
        'methods' => 'POST',
